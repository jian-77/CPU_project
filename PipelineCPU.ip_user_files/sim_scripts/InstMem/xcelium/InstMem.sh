...
#
# Script generated by Vivado on Thu May 23 20:28:11 +0800 2024
...
#
# Usage        : InstMem.sh
#                InstMem.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                InstMem.sh [-reset_run]
#                InstMem.sh [-reset_log]
#                InstMem.sh [-help]
#
...
#                script (type 'InstMem.sh -help' for more information).
#
...
# script info
echo -e "InstMem.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./InstMem.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.InstMem xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.InstMem -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log InstMem_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: InstMem.sh [-step]\n\
Usage: InstMem.sh [-lib_map_path]\n\
Usage: InstMem.sh [-reset_run]\n\
Usage: InstMem.sh [-reset_log]\n\
Usage: InstMem.sh [-keep_index]\n\
