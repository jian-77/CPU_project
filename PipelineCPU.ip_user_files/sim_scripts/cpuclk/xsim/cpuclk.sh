...
#
# Script generated by Vivado on Thu May 23 20:37:02 +0800 2024
...
elaborate()
{
  xelab --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot cpuclk xil_defaultlib.cpuclk xil_defaultlib.glbl -log elaborate.log
}
